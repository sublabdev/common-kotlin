# Contributing to Sublab's Common repository for Kotlin
...
So this is a good place to store new types that do not exist in Kotlin environment, but required for Substrate to work, such as Rust-specific types; some syntax sugar to enhance development speed and code readibility; and different conversions between multiple types that happens frequently.

## Reporting issues

If you have encountered malfunctioning behavior of our produced codebase, please feel free to open an Issue under [Issues section](https://github.com/sublabdev/common-kotlin/issues) with Bug Report template type on this GitHub repository.
...
If you find our library very useful, which we would love to see, but still miss some functionality, please feel free to open an Issue under [Issues section](https://github.com/sublabdev/common-kotlin/issues) with Feature Request template type on this GitHub repository. 
...
If you have developed a feature, please post this under [Pull Requests section](https://github.com/sublabdev/common-kotlin/pulls) of our GitHub repository, and don't forget about some rules:
